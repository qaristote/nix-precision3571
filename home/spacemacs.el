...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-themes '(base16-stylix
                         spacemacs-light)
...
before packages are loaded."
  ...
  (defun my-ediff-dotfile-and-template ()
    (interactive)
    (ediff-files "~/code/nix/machines/latitude-7280/home/spacemacs.el"
  ...
  (defun my-open-dotfile ()
    (interactive)
    (find-file "~/code/nix/machines/latitude-7280/home/spacemacs.el"))
